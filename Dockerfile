...
ARG MATOMO_DIMENSION_UTM_MEDIUM=""
ARG MATOMO_DIMENSION_UTM_CAMPAIGN=""
ARG MATOMO_DIMENSION_UTM_CONTENT=""
ARG MATOMO_DIMENSION_UTM_TERM=""
ARG MATOMO_GOAL_TELEGRAM_CLICK_ID=""
ARG MATOMO_GOAL_WHATSAPP_CLICK_ID=""
ARG MATOMO_GOAL_MAX_CLICK_ID=""
ARG MATOMO_GOAL_CALL_CLICK_ID=""
ARG MATOMO_GOAL_FORM_SUBMIT_ID=""
ARG MATOMO_GOAL_LEAD_ID=""
...
ENV NEXT_PUBLIC_YANDEX_METRIKA_COUNTER_ID="${NEXT_PUBLIC_YANDEX_METRIKA_COUNTER_ID}" \
    ...
    MATOMO_DIMENSION_UTM_MEDIUM="${MATOMO_DIMENSION_UTM_MEDIUM}" \
    ...
    MATOMO_GOAL_TELEGRAM_CLICK_ID="${MATOMO_GOAL_TELEGRAM_CLICK_ID}" \
    MATOMO_GOAL_WHATSAPP_CLICK_ID="${MATOMO_GOAL_WHATSAPP_CLICK_ID}" \
    MATOMO_GOAL_MAX_CLICK_ID="${MATOMO_GOAL_MAX_CLICK_ID}" \
    MATOMO_GOAL_CALL_CLICK_ID="${MATOMO_GOAL_CALL_CLICK_ID}" \
    MATOMO_GOAL_FORM_SUBMIT_ID="${MATOMO_GOAL_FORM_SUBMIT_ID}" \
    MATOMO_GOAL_LEAD_ID="${MATOMO_GOAL_LEAD_ID}" \
